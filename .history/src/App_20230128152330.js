...
function App() {
  ...
  useEffect(() => {
    setTargetProtein(localStorage.getItem('prot') ? JSON.parse(localStorage.getItem('prot'))
      : (""));
    setTargetCalories(localStorage.getItem('cal') ? JSON.parse(localStorage.getItem('cal'))
      : (""));
    setTargetSugar(localStorage.getItem('sug') ? JSON.parse(localStorage.getItem('sug'))
      : (""));
  }, []);
        ...
        <div className="row">
          <div className="col-left">
            <div className="wrapper-card-food-list">
              ...
              />
              <FoodList
                food_data={foods_data.filter((food) => food.name.toLowerCase().includes(searchText))}
