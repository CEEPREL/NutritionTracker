                        ...
                        return (
                            <div style={{ display: "flex", flexWrap: "wrap", flex: '1' }}>
                                ...
                                <div style={{
                                    ...
                                    <br></br>
                                    <p>{result.description ?? 'null'}&nbsp;&nbsp;&nbsp;</p>
                                    <p>Size&nbsp;{result.packageWeight ?? 'null'}g&nbsp;&nbsp;&nbsp;</p>
                                    <p>Protein&nbsp;{result.foodNutrients[0].value ?? 'null'}g&nbsp;&nbsp;&nbsp;</p>
                                    <p>Carbs&nbsp;{result.foodNutrients[2].value ?? 'null'}g&nbsp;&nbsp;&nbsp;</p>
                                    <p>Sugars&nbsp;{result.foodNutrients[4].value ?? 'null'}g&nbsp;&nbsp;&nbsp;</p>
                                    <br></br>
                                </div>
                            </div>
                        )
