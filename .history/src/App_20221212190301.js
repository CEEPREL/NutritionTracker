...
function App() {
  ...
  const [newFoodItems, setNewFoodItems] = useState([]); //totalNutrients is [] empty array

   // Add an item from Food List using add meal btn to right column calculate nutirients tab
   const handleAddFoodItem = (name, size, protein, category) => { //get a meal and add to mealItems
    const [food] = {
