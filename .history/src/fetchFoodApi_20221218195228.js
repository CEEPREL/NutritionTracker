                    ...
                    {fetchedFood.map((result, index) => {
                        return (
                            <div style={{ display: "flex", flexDirection: "column"}}>
                                ...
                                <p>{result.servingSize}g&nbsp;&nbsp;&nbsp;</p>
                                <p>Protein&nbsp;{result.foodNutrients[0].nutrientNumber}&nbsp;&nbsp;&nbsp;</p>
                                <p>Carbs&nbsp;{result.foodNutrients[2].nutrientNumber}&nbsp;&nbsp;&nbsp;</p>
                                <p>Protein&nbsp;{result.foodNutrients[4].nutrientNumber}&nbsp;&nbsp;&nbsp;</p>
