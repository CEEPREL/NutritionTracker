        ...
        {mealItems.length !== 0 && (
          <>
            ...
            <div className="totals-row">
              ...
              <div className="totals-col-1" style={{ textAlign: 'left' }}> h</div>
              <div className="totals-col-1" style={{ textAlign: 'right' }}>h</div>
              <br></br>
            ...
            <div className="totals-row">
              ...
              <div className="">
                <div className="food-nutrients-cal " style={{ marginTop: -10 }}>
