        ...
        {mealItems.length !== 0 && (
          <>
            ...
            <div className="total-food-nutrients" style={{ marginBottom: '3px' }}>
              ...
              <div className="total-food-nutrients-title totals-col-2"><p><b>Total</b></p></div>
            ...
            <div className="total-food-nutrients">
              ...
              <div className="total-food-nutrients-title totals-col-2"> <p><b>Target</b></p></div>
            ...
            <div className="total-food-nutrients">
              ...
              <div className="total-food-nutrients-title totals-col-2"><p><b>Remaining</b></p></div>
              <p><small>Calories</small> <b>{totalServing}g</b></p>
              <p><small>Protein</small> <b>{totalProtein}g</b></p>
              <p><small>Sugar</small> <b>{totalProtein}g</b></p>
            </div>
