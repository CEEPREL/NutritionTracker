  ...
  return (
    <div className="mealItems">
      ...
      <div>
        ...
        <div className="totals-col-1"></div>
          <div className="totals-col-3"><small></small>Qty | Food Name </div>
        ...
        {mealItems.map((item) =>
          <div key={item.id} className="totals-row">
            ...
            <div className="totals-col-1" style={{ textAlign: 'center' }}>{item.protein * item.qty}g</div>
            <div className="totals-col-1" style={{ textAlign: 'center' }}>{item.serving * item.qty}k</div>
            <div className="totals-col-1" style={{ textAlign: 'center' }}>{item.calories * item.qty}c</div>
        ...
        {mealItems.length !== 0 && (
          <>
            ...
            <div className="total-food-nutrients" style={{ marginBottom: '3px' }}>
              ...
              <p>Calories <b>{totalProtein}g</b></p>
              <p>Protein <b>{totalServing}g</b></p>
              <p>Sugar <b>{totalCalories}g</b></p>
            </div>
            ...
            <div className="total-food-nutrients">
              ...
              <p>Calories <b>{totalServing}g</b></p>
              <p>Protein <b>{totalProtein}g</b></p>
              <p>Sugar <b>{totalProtein}g</b></p>
            </div>
            <div className="total-food-nutrients">
