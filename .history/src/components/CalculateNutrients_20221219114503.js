...
export default function CalculateNutrients({ mealItems, countMealItems, onAdd, onRemove }) {
  ...
  const remainingProtein = totalProtein - targetProtein;
  const remainingServing = totalServing - targetServing;
  const remainingCalories = totalCalories - targetCalories;
  const remainingSugar = totalSugar - targetSugar;
  return (
...

      {
        mealItems.length === 0 ? <div>No meals added yet </div> :
          <div>
            ...
            <div className="total-food-nutrients" style={{ marginBottom: '0px', background: 'green' ? {totalCalories} > 1000 : '#1d2127'}}>
            ...
            <div className="total-food-nutrients">
              ...
              <p>Calories <b>2720</b></p>
              <p>Protein <b>110g</b></p>
              <p>Sugar <b>40g</b></p>
            </div>
            ...
            <div className="total-food-nutrients">
              ...
              <p>Calories <b>{remainingProtein}</b></p>
