      ...
      <div>
        ...
        {mealItems.map((item) =>
          <div key={item.id} className="totals-row">
            ...
            <div className="totals-col-3" style={{ textAlign: 'left' }}><small>{item.qty}</small> {item.name} x</div>
            ...
            </div><div className="totals-col-1" style={{ textAlign: 'center' }}>{item.protein * item.qty}</div>
