      ...
      <div>
        ...
        {mealItems.length !== 0 && (
          <>
            ...
            <div className="total-food-nutrients totals-col-2" style={{ background: '#1d2127' }}><p style={{ background: '#1d2127' }}><b>Total</b></p></div>              <p><small>Calories</small> <b>{totalServing}g</b></p>
              <p><small>Protein</small> <b>{totalProtein}g</b></p>
              <p><small>Sugar</small> <b>{totalProtein}g</b></p>
            </div>
