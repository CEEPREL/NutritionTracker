    ...
    <div className="mealItems">
...

      {
        ...
        <div className="totals-row"> {/* Title names for table like look */}
              <div className="totals-col-3"><small></small> </div>
              <div className="totals-col-3" style={{ textAlign: 'right' }}><small></small></div>
              <div className="totals-col-1" style={{ textAlign: 'right' }}><small></small></div>
              <div className="totals-col-1" style={{ textAlign: 'right' }}><small></small></div>
            </div>
