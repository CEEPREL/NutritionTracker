    ...
    <div className="mealItems">
      ...
      <div>
        ...
        <div className="totals-row">
          ...
          <div className="totals-col-1"style={{ textAlign: 'center' }}>Calories</div>
          ...
          <>
            ...
            <div className="totals-row">
              ...
              <div className="" style={{ textAlign: 'center' }}>
                <div className="food-nutrients-cal " style={{ marginTop: 0, textAlign: 'right' }}>
                  <p className=""  style={{ marginTop: 0, textAlign: 'right' }} ><small>Calories</small> <b>{totalServing}g</b></p>
                </div>
              </div>
              <br></br>
