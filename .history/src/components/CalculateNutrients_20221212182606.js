    ...
    <div className="mealItems">
      ...
      <div>
        ...
        <div className="totals-row">
          ...
          <div className="totals-col-1" style={{ textAlign: 'center' }}>Qty</div>
          <div className="totals-col-1" style={{ textAlign: 'right' }}>Protein</div>
          <div className="totals-col-1" style={{ textAlign: 'right' }}>Calories</div>
          <div className="totals-col-1" style={{ textAlign: 'center' }}> <p>Serving</p></div>
        ...
        {mealItems.map((item) =>
          <div key={item.id} className="totals-row">
            ...
            <div className="totals-col-3" style={{ textAlign: 'center' }}><small>x{item.qty}</small> {item.name}</div>
            <div className="totals-btns" style={{ textAlign: 'center' }}>
              <button onClick={() => onRemove(item)} className="food-remove">-</button>
              <button onClick={() => onAdd(item)} className="food-add">+</button>
            </div>
            <div className="totals-col-1" style={{ textAlign: 'center' }}>{item.protein}</div>
            <div className="totals-col-1" style={{ textAlign: 'center' }}>{item.protein}</div>
