...
export default function SetTargets() {
    ...
    return (
        <details style={{ display: 'flex', flexDirection: 'column', border: "1px solid #aaa", borderRadius: "4px", padding: "0.5em", marginTop: "8px" }}>
            <div style={{ display: 'flex', gap: "35px", marginTop: '10px', justifyContent: "left", alignItems: 'flex-end' }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                    <h3>Calories</h3>
                    <input style={{ width: "3rem" }} type="text" />
                </div>

                <div style={{ display: "flex", flexDirection: "column" }}>
                    <h3>Sugar</h3>
                    <input style={{ width: "3.5rem" }} type="text" />
                </div>
