...
export default function SetTargets({ handleAddTargets }) {
    ...
    return (
        <details style={{ display: 'flex', justifyContent: 'spaceBetween', flexDirection: 'column', border: "1px solid #aaa", borderRadius: "4px", padding: "0.5em", marginTop: "8px" }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'spaceBetween'}} >
                ...
                <div id="col2" style={{ flexBasis: '70%', display: 'inlineBlock', marginLeft: '2.5rem', marginRight: '0rem' }}>
                    <br></br>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', gap: "15px", marginTop: '10px', justifyContent: "left", flexWrap: 'wrap' }}>
                        ...
                        <details><summary style={{ color: '#2e828c', fontSize: "1.25rem" }}><b>Protein</b></summary>
