    ...
    return (
        <details style={{ display: 'flex', flexDirection: 'column', border: "1px solid #aaa", borderRadius: "4px", padding: "0.5em", marginTop: "8px" }}>
            ...
            <div style={{ display: 'flex' }} >
                ...
                <div id="col2" style={{ flexBasis: '70%', display: 'inlineBlock', marginLeft: '1rem', marginRight: '1rem'}}>
                    <br></br>
                    <p>Personal notes for calculating targets / gain muscle + weight</p>
                    <div style={{ display: 'flex', flexDirection: 'row', gap: "15px", marginTop: '10px', justifyContent: "left", wrap: 'wrap' }}>
                        <details>
