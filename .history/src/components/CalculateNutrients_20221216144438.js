        ...
        {mealItems.length !== 0 && (
          <>
            ...
            <div className="total-food-nutrients" style={{ marginBottom: '3px' }}>
              ...
              <div className="totals-col-2" style={{ background: '#1d2127' }}><p style={{ background: '#1d2127' }}><b>Total</b></p></div>
            ...
            <div className="total-food-nutrients">
              <div className="totals-col-2" style={{ background: '#1d2127' }}><p style={{ background: '#1d2127' }}><b>Target</b></p></div>
              <p>Calories <b>{totalCalories}</b></p>
              <p>Protein <b>{totalProtein}g</b></p>
              <p>Sugar <b>{totalSugar}g</b></p>
            </div>
            ...
            <div className="total-food-nutrients">
              <div className="totals-col-2" style={{ background: '#1d2127' }}><p style={{ background: '#1d2127' }}><b>Remaining</b></p></div>
              <p>Calories <b>{totalCalories}</b></p>
              <p>Protein <b>{totalProtein}g</b></p>
              <p>Sugar <b>{totalSugar}g</b></p>
            </div>
