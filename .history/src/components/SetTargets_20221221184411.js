...
export default function SetTargets({ targetProtein }) {
    ...
    return (
        ...
        <details style={{ display: 'flex', flexDirection: 'column', border: "1px solid #aaa", borderRadius: "4px", padding: "0.5em", marginTop: "8px" }}>
            ...
            <button type="submit" onClick={handleSubmit}
                style={{ backgroundColor: "#1f6e77", color: 'white', fontSize: "1rem", padding: "0.5rem", fontWeight: "bold", marginTop: "0.5rem" }}>
                Set targets
            </button>
