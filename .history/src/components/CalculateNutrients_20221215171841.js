    ...
    <div className="mealItems">
      ...
      <div>
        ...
        <div className="totals-row">
          ...
          <div className="totals-col-3"><small>x</small> {item.name}</div>

          <div className="totals-col-1"style={{ textAlign: 'center' }}>50</div>
          <div className="totals-col-1"style={{ textAlign: 'center' }}>50</div>
          <div className="totals-col-1"style={{ textAlign: 'center' }}> <p>50</p></div>
