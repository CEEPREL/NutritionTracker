      ...
      <div>
        ...
        {mealItems.length !== 0 && (
          <>
            <hr />
            <div className="totals-row">
              <div className="totals-col-2">Total Nutrients</div>

              <div className="totals-col-1">{totalProtein}</div>
              <div className="totals-col-1">12</div>
              <div className="totals-col-1" style={{ textAlign: 'center' }}> <p>12</p></div>
            ...
            <div className="totals-row">
              ...
              <div className="totals-col-1">120</div>
              <div className="totals-col-1">12</div>
              <div className="totals-col-1" style={{ textAlign: 'center' }}> <p>12</p></div>
              <div className="totals-col-1" style={{ textAlign: 'right' }}>12</div>
              <br></br>
