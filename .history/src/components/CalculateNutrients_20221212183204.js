    ...
    <div className="mealItems">
      ...
      <div>
        ...
        <div className="totals-row">
          ...
          <div className="totals-col-1" style={{ textAlign: 'cenrter' }}>Protein</div>
          <div className="totals-col-1" style={{ textAlign: 'right' }}>Calories</div>
          <div className="totals-col-1" style={{ textAlign: 'right' }}> <p>Serving</p></div>
        ...
        {mealItems.map((item) =>
          ...
          <div className="totals-btns" style={{ textAlign: 'left' }}>
            ...
            <div className="totals-col-1" style={{ textAlign: 'right' }}>{item.protein}</div>
