        ...
        mealItems.length === 0 ?
          ...
          <div>
            ...
            <div className="total-food-nutrients" style={{ marginBottom: '2px', background: 'green' ? { totalCalories } > 1000 : '#1d2127' }}>
              ...
              <p style={{ background: 'green' ? { totalCalories.toFixed(2) } > 1000 : '#1d2127' }}>Calories <b>{totalCalories.toFixed(2)}</b></p>
            ...
            <div className="total-food-nutrients">
              <div className="total-food-nutrients totals-col-2" style={{ background: '#1d2127' }}><p style={{ background: '#1d2127' }}><b>Target</b></p></div>
              <p>Protein <b>{targProtein.toFixed(2)}g</b></p>
              <p>Calories <b>{targCalories.toFixed(2)}</b></p>
              <p>Sugar <b>{targSugar.toFixed(2)}g</b></p>
            </div>
            ...
            <div className="total-food-nutrients">
              ...
              <p>Protein <b>{remainingProtein.toFixed(2)}g</b></p>
              <p>Calories <b>{remainingCalories.toFixed(2)}</b></p>
              <p>Sugar <b>{remainingSugar.toFixed(2)}g</b></p>
            </div>

            {/* Extra box info */}
            {/* <span>Extra daily meals total info</span> */}
            <div className="total-food-nutrients" style={{ marginTop: '22px' }}>
              <p><small>Serving</small> <b>{totalServing.toFixed(2)}g</b></p>
              <p><small>Protein</small> <b>{totalProtein.toFixed(2)}g</b></p>
              <p><small>Carbs</small> <b>{totalProtein.toFixed(2)}g</b></p>
              <p><small>Fat</small> <b>{totalProtein.toFixed(2)}g</b></p>
              <p><small>Sugar</small> <b>{totalSugar.toFixed(2)}g</b></p>
            </div>
          </div>
      }
    </div>
