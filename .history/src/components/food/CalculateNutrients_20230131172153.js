          ...
          <div>
            ...
            {mealItems.map((item) =>
              <div key={item.id} className="totals-row">
                ...
                <div className="hoverText totals-col-3 hoverText" style={{ textAlign: 'left', whiteSpace:'wrap', overflow:'hidden', textOverflow:'ellipsis'}}><small>x{item.qty}</small> {item.name}</div>
