          ...
          <div>
            ...
            {mealItems.map((item) =>
              <div key={item.id} className="totals-row">
                ...
                <div className="hoverText totals-col-3 hoverText" style={{ textAlign: 'left', whiteSpace:'noWrap', overflow:'hidden', textOverflow:'ellipsis', hover:}}><small>x{item.qty}</small> {item.name}</div>
