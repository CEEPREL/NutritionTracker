    ...
    <div className="mealItems">
      ...
      <div>
        ...
        {mealItems.map((item) =>
          ...
          <div className="totals-btns" style={{ textAlign: 'left' }}>
            ...
            <div className="totals-col-1" style={{ textAlign: 'left' }}>{item.protein}</div>
          ...
          <>
            ...
            <div className="totals-row">
              ...
              <div className="" style={{ textAlign: 'center' }}>
                <div className="food-nutrients-cal " style={{ marginTop: 3, justifyContent: 'center' }}>
