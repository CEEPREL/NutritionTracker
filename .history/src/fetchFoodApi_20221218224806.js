...
export default function FetchFoodApi() {
    ...
    const fetchData = () => {
        if (typedFood === ' ') { return }
        fetch(`https://api.nal.usda.gov/fdc/v1/foods/search?api_key=${API_KEY}&query=${typedFood}&pageSize=7`)
            .then((response) => {
                        ...
                        return (
                            <div style={{ display: "flex", flexWrap: "wrap", flex: '1'}}>
                                ...
                                <div style={{
                                    ...
                                    minWidth: '14rem', maxWidth: '14rem', padding:'0.4rem', border: '1px solid black'
                                }}>
                                    <br></br>
                                    {!typedFood === ' ' ? (
                                        <p>{typedFood}</p>
