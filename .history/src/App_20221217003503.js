      ...
      <div className="row">
        ...
        <div className="col-left">
          <div className="wrapper-card-food-list">
            <FoodList onAdd={onAdd} onRemove={onRemove} 
            mealItems={mealItems} food_data={newFoodItems} handleAddFoodItem={handleAddFoodItem} handleDeleteFoodItem={handleDeleteFoodItem} />
          </div>
        </div>
