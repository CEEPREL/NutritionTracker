...
function App() {
  ...
  const [data, setData] = useState([]); //totalNutrients is [] empty array
  ...
  const handleAddFoodItem = (name) => { //get a meal and add to mealItems
    console.log("in func")
    const food = {
      id: nanoid(),
      name: name,
    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-left">
          <div className="wrapper-card">
            <FoodList onAdd={onAdd} onRemove={onRemove} mealItems={mealItems} food_data={food_data} handleAddFoodItem={handleAddFoodItem} />
          </div>
        </div>
